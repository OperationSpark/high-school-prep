...
* **Bootcamp:** (Prerequisites : Prep) Our one-month coding Bootcamp is a deep dive into JavaScript.  The course focuses on basic programming concepts, functional programming, and basic web development. Students qualify for Bootcamp once they've fully completed the Prep program material and passed the Bootcamp entrance coding quiz.
